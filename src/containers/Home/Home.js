...
export class Home extends Component {
      ...
      <Navbar className={styles.header}>
        <Nav pullRight>
          <NavDropdown title="Menu">
            <MenuItem
              onClick={this.handleMenuGraphOptionClick(
                MenuOptions.MULTI_GRAPHS
              )}
            >
              Multi graphs
            </MenuItem>
            <MenuItem
              onClick={this.handleMenuGraphOptionClick(MenuOptions.POLAR_GRAPH)}
            >
              Polar graphs
            </MenuItem>
            <MenuItem
              onClick={this.handleMenuGraphOptionClick(MenuOptions.BAR_GRAPH)}
            >
              Bar graphs
            </MenuItem>
            <MenuItem
              onClick={this.handleMenuGraphOptionClick(MenuOptions.TABLE)}
            >
              Table
            </MenuItem>
            <MenuItem divider />
  ...
  get innerContent() {
    ...
    return <div className={styles.innerContent}>{element}</div>;
  }
